...
import { homeSafeProducts, homeSafeDiscountPercent } from "@/lib/homeSafes";

export default function HomeSafesCatalogPage() {
  return (
    <>
      <Header />
      <main>
        <section className="py-12 sm:py-16">
          <div className="mx-auto max-w-[1180px] px-6 sm:px-8">
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              ...
              <TrustBadge variant="light" label="עיגון מקצועי לקיר/רצפה" />
            </div>
            ...
            <div className="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
              {homeSafeProducts.map((p) => (
                <ProductListCard
                  ...
                  discountPercent={homeSafeDiscountPercent(p)}
